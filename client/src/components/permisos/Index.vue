    ...
    <el-table v-loading="loading" :data="data" style="width: 100%">
        <el-table-column prop="name" label="Nombre" sortable>
          <template slot-scope="scope">
            {{ scope.row.ApellidosEmpleado }}, {{ scope.row.NombreEmpleado }}
          </template>
        </el-table-column>
        <el-table-column prop="TipoPermiso" label="Tipo" width="500" sortable></el-table-column>
        <el-table-column prop="FechaPermiso" label="Fecha" width="500" sortable></el-table-column>
