  ...
  data: () => ({
    items: [
      { icon: "dashboard", text: "Dashboard", path: "/" },
      {
        ...
        text: "Permisos",
        children: [
          { icon: "plus", text: "Agregar", path: "/permisos/add" },
          { icon: "list", text: "Listar", path: "/permisos" },
        ]
      },
      {
        icon: "user",
        text: "TipoPermisos",
        children: [
          { icon: "plus", text: "Agregar", path: "/tipoPermisos/add" },
          { icon: "list", text: "Listar", path: "/tipoPermisos" },
        ]
      }
    ]
  }),
